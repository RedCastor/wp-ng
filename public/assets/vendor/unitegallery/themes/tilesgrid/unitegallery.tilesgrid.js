if (typeof g_ugFunctions != "undefined") g_ugFunctions.registerTheme("tilesgrid"); else jQuery(document).ready(function() {
...
function UGTheme_tilesgrid() {
    ...
    function modifyOptions() {
        if (!g_options.grid_num_rows) g_options.grid_num_rows = 9999;
    ...
    function setHtml() {
        ...
        if (g_objBullets) g_objBullets.appendHTML(g_objWrapper);
    ...
    function positionElements() {
        ...
        if (numPanes > 1) {
            ...
            if (g_objBullets) g_objBullets.getElement().hide();
        }
    ...
    function onBeforeReqestItems() {
        if (g_objNavWrapper) g_objNavWrapper.hide();
        if (g_objThumbsGrid) g_objThumbsGrid.getElement().hide();
    ...
    function initEvents() {
        ...
        if (g_objBullets) g_objThumbsGrid.attachBullets(g_objBullets);
        if (g_objNavWrapper) {
    ...
    this.destroy = function() {
        ...
        if (g_objBullets) jQuery(g_objBullets).off(g_objBullets.events.BULLET_CLICK);
...
//# sourceMappingURL=unitegallery.tilesgrid.js.map
