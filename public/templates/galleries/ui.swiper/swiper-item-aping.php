<?php
/**
 * Angular UI Swiper Item apiNG
 *
 *
 * This template can be overridden by copying it to yourtheme/wp-ng/galleries/ui.swiper/swiper-item-aping.php.
 *
 * @package    Wp_Ng
...
?>
<ui-swiper-slide data-ng-repeat="item in sources" >
  <figure class="<?php echo implode(' ', $class_item); ?>" data-ng-class="item.source.class" >
    ...
    <section data-ng-if="item.source.content" class="swiper-slide-content" data-ng-class="item.source.content_class">
