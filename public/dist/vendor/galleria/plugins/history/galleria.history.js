(function($, window) {
    ...
    Galleria.History = function() {
        var onloads = [], init = false, loc = window.location, doc = window.document, ie = Galleria.IE, support = "onhashchange" in window && (doc.mode === undefined || doc.mode > 7), iframe, get = function(winloc) {
        ...
        }, saved = get(loc), callbacks = [], onchange = function() {
...
//# sourceMappingURL=galleria.history.js.map
